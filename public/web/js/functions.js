...
$(document).ready(function() {
    ...
    function getGridSize() {
        var strs = $('#thumbManagement').attr('data-count');
        return (window.innerWidth < 600) ? 2 :
               (window.innerWidth < 900) ? 2 : strs;
    }
    // $('#thumbManagement').henwaslide({
    //    animation: "slide",
    //    controlNav: false,
    //    animationLoop: false,
    //    slideshow: false,
    ...
    //    asNavFor: '#slideManagement',
    //    directionNav: true,
    // });

    // $('#slideManagement').henwaslide({
    //    animation: "slide",
    //    controlNav: false,
    //    animationLoop: false,
    //    slideshow: false,
    //    directionNav: false,
    //    sync: "#thumbManagement",
    //    start: function(slider){
    //       // $('#slideManagement').addClass('okeee');
    //       // var heimanagement = $(".contentmg.okeee");
    //       // var imagekonten = heimanagement.height();
    //       // alert(imagekonten);
    //       // $('.contentmg .imagemng').css({'height': imagekonten + 'px'});
    ...
    $csrlayout.imagesLoaded().progress(function() {
        $csrlayout.isotope({
            animationOptions: {
                duration: 750,
                itemSelector: ".project-item",
