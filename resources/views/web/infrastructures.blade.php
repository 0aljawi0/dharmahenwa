...
@section('content')
    ...
    @component('web.components.page_title')
        ...
        @slot('title') {{Session::get('locale') == 'id' ? 'Infrastruktur Pertambangan & Layanan Lainnya' : 'Mining Infrastructure & Other Service'}} @endslot
    @endcomponent
              ...
              <div class="col-xs-12 col-sm-12">
                 <div class="content-breadcrumb pb-sm">
                    <ol class="breadcrumb">
                       ...
                       <li class="active">
                            {{Session::get('locale') == 'id' ? 'Infrastruktur Pertambangan & Layanan Lainnya' : 'Mining Infrastructure & Other Service'}}
                       </li>
                    </ol>
                 </div>
                 <div class="row">
