...
@section('content')
    ...
    @component('web.components.page_title')
        ...
        @slot('title') {{Session::get('locale') == 'id' ? 'Jasa Manajemen Pelabuhan' : 'Port Management Services'}} @endslot
    @endcomponent
              ...
              <div class="col-xs-12 col-sm-12">
                 <div class="content-breadcrumb pb-sm">
                    <ol class="breadcrumb">
                       ...
                       <li class="active">
                            {{Session::get('locale') == 'id' ? 'Jasa Manajemen Pelabuhan' : 'Port Management Services'}}
                       </li>
                    </ol>
                 </div>
                 <div class="row">
