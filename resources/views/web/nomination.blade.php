...
@section('content')
    ...
    @component('web.components.page_title')
        ...
        @slot('title') {{Session::get('locale') == 'id' ? 'Komite Nominasi & Remunerasi' : 'Nomination & Remuneration Committee'}} @endslot
    @endcomponent
                ...
                <div class="col-xs-12 col-sm-12">
                    ...
                    <div class="content-breadcrumb pb-sm">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                {{Session::get('locale') == 'id' ? 'Komite Nominasi & Remunerasi' : 'Nomination & Remuneration Committee'}}
                            </li>
                        </ol>
                    </div>
