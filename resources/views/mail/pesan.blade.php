...
<head>
    ...
    <title>Message Darmahenwa</title>
    <style type="text/css">
            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                        <td class="soapbox-title">Message Darmahenwa</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">{{$data->subject}}</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                                ...
                                Email : {{$data->email}} <br>
                                Phone : {{$data->phone}} <br>
                                Message Created Date : {{date('d F Y H:i', strtotime($data->created_at))}} <br>
                                <hr>
                                <p>{{$data->message}}</p>
                            </td>
                          </tr>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p class="body-signature">This report is sent from the darmahenwa website</p>
                            </td>
                          </tr>
                        </table>
                      </td>
