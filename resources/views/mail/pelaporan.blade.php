...
<head>
    ...
    <title>Whistleblowing Darmahenwa</title>
    <style type="text/css">
            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                        <td class="soapbox-title">Whistleblowing Darmahenwa</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Violation Report</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                                ...
                                Email : {{$data->email}} <br>
                                Phone : {{$data->phone}} <br>
                                Violation Category : <b>{{$data->category_violation}}</b> <br>
                                Party Reported : <b>{{$data->party_reported}}</b> <br>
                                Violation Detail : <b>{{$data->violation_detail}}</b> <br>
                                Report Created Date : {{date('d F Y H:i', strtotime($data->created_at))}}
                            </td>
                          </tr>
                        </table>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p class="body-signature">This report is sent from the darmahenwa website, Evidence in attachments</p>
                            </td>
                          </tr>
                        </table>
                      </td>
