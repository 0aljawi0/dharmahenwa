...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 animate__animated animate__fadeInDown">
        ...
        <div class="btn-group" role="group">
            ...
            <a href="{{route('sliders.create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-user fa-sm text-white-50"></i> Create New Slider</a>
        </div>
    </div>
                ...
                <tbody>
                    @foreach ($sliders as $key => $item)
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="{{route('sliders.edit', ['slider' => $item->id])}}" class="btn btn-info btn-sm"> <i class="fas fa-pencil-alt fa-sm fa-fw"></i> <span>Edit</span></a>
                                ...
                                <form id="destroy_{{$item->id}}" action="{{route('sliders.destroy', ['slider' => $item->id])}}" method="POST"> @csrf @method('DELETE') </form>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
