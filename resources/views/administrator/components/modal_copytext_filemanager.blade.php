                 ...
                 $('#images').append(`
                    <div class="card p-2">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" id="copylink-image${item.id}" class="form-control" value="{{URL::to('/')}}/storage/${item.path}">
                            <div class="input-group-append">
                                <button type="button" class="btn btn-sm btn-primary copy-btn" data-clipboard-target="#copylink-image${item.id}" onclick="closeModal('{{URL::to('/')}}/storage/${item.path}')">
            ...
            $.each(data.document, function (i, item) {
                 $('#documents').append(`
                    <div class="card p-2 text-center">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" id="copylink-pdf${item.id}" class="form-control" value="{{URL::to('/')}}/storage/${item.path}">
                            <div class="input-group-append">
                                <button type="button" class="btn btn-sm btn-primary copy-btn" data-clipboard-target="#copylink-pdf${item.id}" onclick="closeModal('{{URL::to('/')}}/storage/${item.path}')">
                                    <i class="fas fa-copy fa-sm fa-fw"></i>
                                    Copy Link
                                </button>
                            </div>
