...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 animate__animated animate__fadeInDown">
        <h1 class="h3 mb-0 text-gray-800">Create New Sustainability Report</h1>

        <a href="{{route('sustainablities.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fas fa-arrow-left fa-sm text-white-50"></i> Back To Sustainability Reports</a>
    </div>
    ...
    <div class="row animate__animated animate__fadeInUp">
        ...
        <div class="col-lg-6 mb-4">
            ...
            <form action="{{route('sustainablities.store')}}" method="POST">
                @csrf
