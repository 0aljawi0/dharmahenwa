...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4 animate__animated animate__fadeInDown">
        <h1 class="h3 mb-0 text-gray-800">Edit Press Release</h1>

        <a href="{{route('blogs.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm"><i class="fas fa-arrow-left fa-sm text-white-50"></i> Back To Blogs</a>
    </div>
        ...
        <div class="col-lg-12 mb-4">
            ...
            <form action="{{route('blogs.update', ['blog' => $blog->id])}}" method="POST">
                ...
                @component('administrator.components.input_filemanager')
                    ...
                    @slot('required') required @endslot
                    @slot('value') {{$blog->image}} @endslot
                    @slot('image') <img src="{{asset('storage/'.$blog->image)}}" alt="preview" width="200"> @endslot
                @endcomponent
